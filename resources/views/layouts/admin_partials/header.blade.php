...
<head>
  ...
  <title>Music Voting | Admin Panel</title>
...
<div class="wrapper" style="width: 100%;">
  <header class="main-header">
    <!-- Logo -->
    <a href="{{route('is_admin')}}" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
         @include('layouts.admin_partials.notification')
          <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('public/dashboard/profile_images/' . Auth::user()->image)}}" class="user-image" alt="User Image">
