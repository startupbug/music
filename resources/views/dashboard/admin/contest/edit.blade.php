            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class='input-group date col-md-8' id='datetimepicker1'>
                    <input type='text' class="form-control" name="start_date" value="{{ date('Y-m-d', strtotime($edit->start_date))}}" />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class='input-group date col-md-8' id='datetimepicker2'>
                    <input type='text' class="form-control" name="end_date" value="{{ date('Y-m-d', strtotime($edit->end_date)) }} "/>
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
