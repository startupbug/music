...
<!--<footer>
    <div class="container-fluid bg_red_color">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="footer_logo">
                        <a href="#">
                            <img src="images/site_logo_white.png" class="img-responsive center-block"/>
                        </a>
                        <ul class="clearfix">
                            <li>
                                <a href="#">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="copy_right">
                        <p>All rights Reserved © 2017 Music Voting, Designed & Developed by Startupbug.net</p>
                    </div>
                </div>
            </div>
        </div>
